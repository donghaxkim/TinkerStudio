...
export const ManualFixtureProgressStatusSchema = z.enum([
  "queued",
  "running",
  "capturing",
  "assembling",
...
export const ManualFixtureProgressEventSchema = z.object({
  jobId: z.string().min(1),
  status: ManualFixtureProgressStatusSchema,
  message: z.string().min(1),
  time: z.string().min(1),
  artifactPath: z.string().min(1).optional(),
});

export const AssistedGenerationProgressEventSchema = z.object({
  id: z.string().min(1),
  jobId: z.string().min(1),
...
export const GenerationProgressEventSchema = z.union([
  ManualFixtureProgressEventSchema,
  AssistedGenerationProgressEventSchema,
]);
